...
# Convert a file
bin/ie32to64 assembler/rotozoomer.asm
# → produces assembler/rotozoomer_ie64.asm

# Convert with explicit output path
bin/ie32to64 -o output.asm assembler/rotozoomer.asm

# Upgrade to 64-bit operations
bin/ie32to64 -size .q assembler/program.asm

# Print conversion statistics
bin/ie32to64 -stats assembler/rotozoomer.asm
```
