...
var VideoModes = map[uint32]VideoMode{
	MODE_320x200: {
		width:       RESOLUTION_320x200_WIDTH,
		height:      RESOLUTION_320x200_HEIGHT,
		bytesPerRow: RESOLUTION_320x200_WIDTH * BYTES_PER_PIXEL,
		totalSize:   RESOLUTION_320x200_WIDTH * RESOLUTION_320x200_HEIGHT * BYTES_PER_PIXEL,
	},
	MODE_320x240: {
		width:       RESOLUTION_320x240_WIDTH,
		height:      RESOLUTION_320x240_HEIGHT,
		bytesPerRow: RESOLUTION_320x240_WIDTH * BYTES_PER_PIXEL,
		totalSize:   RESOLUTION_320x240_WIDTH * RESOLUTION_320x240_HEIGHT * BYTES_PER_PIXEL,
	},
	MODE_640x480: {
