...
func boilerPlate() {
	...
	fmt.Printf("\nIntuition Engine %s\n", Version)
	fmt.Println("A modern 64-bit RISC re-imagining of Commodore/Atari/Sinclair/BBC/Amstrad/IBM 8/16/32-bit home computers.")
	...
	fmt.Println("20+ retro chiptune formats  : ProTracker MOD 4/6/8 channel, PCM WAV, MIDI SMF & Doom MUS, AHX/THX (Resynthesized), PSID/RSID/MultiSID, TED/TMF/PRG, SAP B/C, YM2/YM3/YM3b/YM4/YM5/YM6/LHA, AY, VGM/VGZ, SNDH/SND, VTX/VT, PT1/PT2/PT3, STC, SQT, ASC, FTC.")
