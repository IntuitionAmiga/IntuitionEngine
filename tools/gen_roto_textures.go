...
var rotoVariants = []rotoVariant{
	...
	{label: "EMUTOS", base: "rotozoomtexture", rawPath: "sdk/examples/assets/rotozoomtexture_emutos.raw", pngPath: "sdk/examples/assets/rotozoomtexture_emutos.png"},
	{label: "APIASM", base: "rotozoomtexture", rawPath: "sdk/examples/assets/rotozoomtexture_api_asm.raw", pngPath: "sdk/examples/assets/rotozoomtexture_api_asm.png"},
	{label: "HW ASM", base: "rotozoomtexture", rawPath: "sdk/examples/assets/rotozoomtexture_hw_asm.raw", pngPath: "sdk/examples/assets/rotozoomtexture_hw_asm.png"},
	{label: "API C", base: "rotozoomtexture", rawPath: "sdk/examples/assets/rotozoomtexture_api_c.raw", pngPath: "sdk/examples/assets/rotozoomtexture_api_c.png"},
	{label: "HW C", base: "rotozoomtexture", rawPath: "sdk/examples/assets/rotozoomtexture_hw_c.raw", pngPath: "sdk/examples/assets/rotozoomtexture_hw_c.png"},
