// jit_fload_fstore_helper_arm64_test.go — Phase 5 cycle 5.6 ARM64 FLOAD/FSTORE helper-exit.
...
func TestJIT_ARM64_FLOAD_HighAddr_SetsHelper(t *testing.T) {
	r := newJITTestRig(t)
	if r.cpu.FPU == nil {
...
func TestJIT_ARM64_FLOAD_MMUEnabled_SetsHelper(t *testing.T) {
	r := newJITTestRig(t)
	if r.cpu.FPU == nil {
		t.Skip("FPU not initialised")
	}
...
func TestJIT_ARM64_FLOAD_LowAddr_NoHelper(t *testing.T) {
	r := newJITTestRig(t)
	if r.cpu.FPU == nil {
		t.Skip("FPU not initialised")
	}
...
func TestJIT_ARM64_FSTORE_HighAddr_SetsHelper(t *testing.T) {
	r := newJITTestRig(t)
	if r.cpu.FPU == nil {
		t.Skip("FPU not initialised")
	}
...
func TestJIT_ARM64_FSTORE_LowAddr_NoHelper(t *testing.T) {
	r := newJITTestRig(t)
	if r.cpu.FPU == nil {
		t.Skip("FPU not initialised")
	}
