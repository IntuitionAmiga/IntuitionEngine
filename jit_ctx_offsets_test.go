...
func TestJITContext_FieldOffsets(t *testing.T) {
	...
	cases := []struct {
		...
		{"ResumeAddr", jitCtxOffResumeAddr, unsafe.Offsetof(ctx.ResumeAddr)},
		{"ResumePC", jitCtxOffResumePC, unsafe.Offsetof(ctx.ResumePC)},
		{"ResumePTBR", jitCtxOffResumePTBR, unsafe.Offsetof(ctx.ResumePTBR)},
		{"ResumeCountBase", jitCtxOffResumeCountBase, unsafe.Offsetof(ctx.ResumeCountBase)},
		{"ResumeMMUEnabled", jitCtxOffResumeMMUEnabled, unsafe.Offsetof(ctx.ResumeMMUEnabled)},
		{"ResumeValid", jitCtxOffResumeValid, unsafe.Offsetof(ctx.ResumeValid)},
		{"MicroTLBReadPrefix", jitCtxOffMicroTLBReadPrefix, unsafe.Offsetof(ctx.MicroTLBReadPrefix)},
		{"MicroTLBWritePrefix", jitCtxOffMicroTLBWritePrefix, unsafe.Offsetof(ctx.MicroTLBWritePrefix)},
		{"MicroTLBKeys", jitCtxOffMicroTLBKeys, unsafe.Offsetof(ctx.MicroTLBKeys)},
		{"MicroTLBPhys", jitCtxOffMicroTLBPhys, unsafe.Offsetof(ctx.MicroTLBPhys)},
		{"CodePageBitmapPtr", jitCtxOffCodePageBitmapPtr, unsafe.Offsetof(ctx.CodePageBitmapPtr)},
		{"InvalAddr", jitCtxOffInvalAddr, unsafe.Offsetof(ctx.InvalAddr)},
		{"InvalSize", jitCtxOffInvalSize, unsafe.Offsetof(ctx.InvalSize)},
		{"CodePageBitmapLen", jitCtxOffCodePageBitmapLen, unsafe.Offsetof(ctx.CodePageBitmapLen)},
		{"CodeHighStartPage", jitCtxOffCodeHighStartPage, unsafe.Offsetof(ctx.CodeHighStartPage)},
		{"CodeHighEndPage", jitCtxOffCodeHighEndPage, unsafe.Offsetof(ctx.CodeHighEndPage)},
		{"PhysCodeBitmapPtr", jitCtxOffPhysCodeBitmapPtr, unsafe.Offsetof(ctx.PhysCodeBitmapPtr)},
		{"PhysCodeBitmapLen", jitCtxOffPhysCodeBitmapLen, unsafe.Offsetof(ctx.PhysCodeBitmapLen)},
	}
	for _, c := range cases {
		if c.want != c.got {
