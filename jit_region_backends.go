...
// RegionScanResult and ScanRegionM68K moved to the untagged
// jit_region_scan_m68k.go (M68K JIT parity plan, milestone 2): the M68020
// region scanner is backend-neutral frontend analysis that arm64 and wasm
// backends must be able to consume.
