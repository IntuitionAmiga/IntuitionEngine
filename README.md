...
- `sdk/intuitionos/iexec/handler/shell.s` owns `prog_shell` — `prog_shell` now lives in a dedicated handler source file.
- `sdk/intuitionos/iexec/lib/dos_library.s` owns `prog_doslib` — `prog_doslib` now lives in its own library source file.
