...
func (d *DebugZ80) StopForAccessHit() {
	if d.cpu != nil {
...
func (d *DebugZ80) SnapshotBreakpoint(addr uint64) (BreakpointSnapshot, bool) {
	return snapshotBreakpointLocked(&d.bpMu, d.breakpoints, addr)
}

func (d *DebugZ80) IncrementBreakpointHit(addr uint64) (uint64, bool) {
	return incrementBreakpointHitLocked(&d.bpMu, d.breakpoints, addr)
}

func (d *DebugZ80) SetBreakpointCondition(addr uint64, cond *BreakpointCondition) bool {
	return setBreakpointConditionLocked(&d.bpMu, d.breakpoints, addr, cond)
}

func (d *DebugZ80) ListBreakpointSnapshots() []BreakpointSnapshot {
...
func (d *DebugZ80) SnapshotWatchpoint(addr uint64) (WatchpointSnapshot, bool) {
	return snapshotWatchpointLocked(&d.bpMu, d.watchpoints, addr)
}

func (d *DebugZ80) UpdateWatchpointLastValue(addr uint64, val byte) bool {
	return updateWatchpointLastValueLocked(&d.bpMu, d.watchpoints, addr, val)
}

func (d *DebugZ80) ListWatchpointSnapshots() []WatchpointSnapshot {
	return listWatchpointSnapshotsLocked(&d.bpMu, d.watchpoints)
}

func (d *DebugZ80) ValidateAddress(addr uint64) error {
...
func (d *DebugZ80) SetBreakpointChannel(ch chan<- BreakpointEvent, cpuID int) {
	...
	if d.cpu != nil {
		...
		if adapter, ok := d.cpu.bus.(*Z80BusAdapter); ok {
...
func (d *DebugZ80) SetDebugFaultService(faults *DebugFaultService) {
	if d.cpu != nil {
