...
func TestSDKInclude_32BitConstantParity(t *testing.T) {
	expected := map[string]uint32{
		...
		"STATUS_FB_ERROR":        videoStatusFramebufferErr,
		"MODE_640x480":           MODE_640x480,
		"MODE_800x600":           MODE_800x600,
		"MODE_1024x768":          MODE_1024x768,
		"MODE_1280x960":          MODE_1280x960,
		"MODE_320x200":           MODE_320x200,
		"MODE_320x240":           MODE_320x240,
		"MODE_1920x1080":         MODE_1920x1080,
		"MODE_960x540":           MODE_960x540,
		"IE_SFX_CH_BASE":         IE_SFX_CH_BASE,
		"IE_SFX_CH_STRIDE":       IE_SFX_CH_STRIDE,
		"IE_SFX_LEGACY_CHANNELS": IE_SFX_LEGACY_CHANNELS,
		"IE_SFX_CHANNELS":        IE_SFX_CHANNELS,
		"IE_SFX_EXT_REGION_BASE": IE_SFX_EXT_REGION_BASE,
		"IE_SFX_EXT_REGION_END":  IE_SFX_EXT_REGION_END,
		"IE_SFX_EXT_CH_BASE":     IE_SFX_EXT_CH_BASE,
		"IE_SFX_EXT_CH0_BASE":    IE_SFX_EXT_CH_BASE,
		"IE_SFX_EXT_CH31_BASE":   IE_SFX_EXT_CH_BASE + 31*IE_SFX_CH_STRIDE,
		"SFX_PTR":                SFX_PTR,
		"SFX_LEN":                SFX_LEN,
...
func TestSDKInclude_SFXAndLowRes8BitAliases(t *testing.T) {
	...
	for key, want := range map[string]uint32{
		...
		"IE_SFX_EXT_REGION_BASE": IE_SFX_EXT_REGION_BASE,
		"IE_SFX_EXT_REGION_END":  IE_SFX_EXT_REGION_END,
		"IE_SFX_EXT_BANK":        IE_SFX_8BIT_EXT_BANK,
		"IE_SFX_EXT_WINDOW_BASE": IE_SFX_8BIT_EXT_CH_BASE,
		"IE_SFX_EXT_WINDOW_END":  IE_SFX_8BIT_EXT_REGION_END,
		"IE_SFX_EXT_CH_BASE":     IE_SFX_8BIT_EXT_CH_BASE,
		"IE_SFX_EXT_CH0_BASE":    IE_SFX_8BIT_EXT_CH_BASE,
		"IE_SFX_EXT_CH31_BASE":   IE_SFX_8BIT_EXT_CH_BASE + 31*IE_SFX_CH_STRIDE,
		"SFX_PAN_RESERVED":       SFX_PAN_RESERVED,
		"SFX_CTRL_TRIGGER":       SFX_CTRL_TRIGGER,
		"SFX_STATUS_PLAYING":     SFX_STATUS_PLAYING,
	} {
