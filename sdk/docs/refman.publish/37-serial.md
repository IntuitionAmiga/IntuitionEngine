...
small-address terminal routes are documented in Chapters 26 and 27.
...
cooked-key queue at `$F0728`, described in Chapter 36. BASIC `GET`
...
scan port. Programs that need binary file data use Chapter 34.
Programs that need raw keystrokes use Chapter 36.
