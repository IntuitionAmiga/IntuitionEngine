...
SID, PSG, TED, AHX, POKEY, MOD, and WAV players. It does not silence raw
chip registers that you have written directly; turn those down with
their own volume or gate controls.
...
`..` are rejected. AHX and TED use a 64 KB staging buffer; MOD and WAV
can be larger because they load directly into their players.
