...
```basic
10 POKE32 &H000F22A0,&H8001:REM ENABLE CHANNEL 0
20 POKE32 &H000F22A0,&H800F:REM ENABLE CHANNELS 0-3
30 POKE32 &H000F22A0,1:REM DISABLE CHANNEL 0
40 POKE32 &H000F22A8,&H8001:REM ENABLE CH0 COMPLETION IRQ
50 POKE32 &H000F22A8,1:REM DISABLE CH0 COMPLETION IRQ
```
...
1. Enable audio with `POKE32 &H000F0800,1`.
...
```basic
10 POKE32 &H000F22A0,1
```

To stop all four channels:

```basic
10 POKE32 &H000F22A0,15
```
