...
Chapter 30, section 30.3. The handler reads
...
## 31.11 What Comes Next

Chapter 32 covers IE Mon, the interactive monitor that lets you
single-step any CPU, examine registers, set breakpoints and
watchpoints, and inspect the bus from a command prompt. Chapter
33 covers IE Script, the scripting surface that drives the monitor
