...
| Architecture | memory map row | `0xF23C0-0xF23DF` | `registers.go` IRQ diagnostic constants; `aros_loader.go` `MapIRQDiagnostics`; `main.go` AROS call sites; `aros_audio_dma.go` `UnmapIO` teardown |
