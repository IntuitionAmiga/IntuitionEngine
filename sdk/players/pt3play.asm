; Wrapper for PTx player - assembles with our entry point trampoline

; Define these before including PTx.a80
	define	PUREPLAYER
	define	SINGLESETUP
...
; Dummy label for music_init (not used - we call music_init0 directly)
MDLADDR	equ	#4000
