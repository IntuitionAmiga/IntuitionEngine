...
; ============================================================================
;
; The service spins on head != tail. B holds the tail value for
...
; ============================================================================
;
; We need three values from the entry: reqPtr (entry+16),
...
; ============================================================================
;
; Like the 6502, the Z80 is an 8-bit CPU and must chain four byte
...
; ============================================================================
;
; The response descriptor tells the caller what happened. We must
