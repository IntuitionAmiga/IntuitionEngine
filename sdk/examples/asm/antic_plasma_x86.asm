...
; Video Chip:    ANTIC/GTIA (Atari 400/800/XL/XE display system)
; Audio Engine:  SID (Commodore 64 sound chip)
; Assembler:     nasm (Netwide Assembler)
; Build:         nasm -f bin -o antic_plasma_x86.ie86 antic_plasma_x86.asm
; Run:           ./bin/IntuitionEngine -x86 antic_plasma_x86.ie86
; Porting:       ANTIC/GTIA MMIO is CPU-agnostic. Display list programming is
;                the same from any CPU core. SID audio setup is also identical.
;
