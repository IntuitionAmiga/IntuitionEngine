...
.visible:
    ...
    ; sine_index = (char_x + frame_counter) & 0xFF
    ld a,(char_x)               ; screen X pixel position (low byte)
    ld hl,(frame_lo)
    add a,l                     ; + frame counter (low byte)
    ld l,a
...
; --- Scroll sine table (256 entries, 16-bit signed, +/-18 pixels) ---
...
scroll_sine_lo:
    ...
    .byte 0x04,0x04,0x05,0x05,0x06,0x06,0x06,0x07
    .byte 0x07,0x08,0x08,0x09,0x09,0x09,0x0A,0x0A
    .byte 0x0A,0x0B,0x0B,0x0B,0x0C,0x0C,0x0C,0x0D
    .byte 0x0D,0x0D,0x0D,0x0E,0x0E,0x0E,0x0E,0x0F
    .byte 0x0F,0x0F,0x0F,0x0F,0x10,0x10,0x10,0x10
    .byte 0x10,0x11,0x11,0x11,0x11,0x11,0x11,0x11
    .byte 0x11,0x12,0x12,0x12,0x12,0x12,0x12,0x12
    .byte 0x12,0x12,0x12,0x12,0x12,0x12,0x12,0x12
    .byte 0x12,0x11,0x11,0x11,0x11,0x11,0x11,0x11
    .byte 0x11,0x10,0x10,0x10,0x10,0x10,0x0F,0x0F
    .byte 0x0F,0x0F,0x0F,0x0E,0x0E,0x0E,0x0E,0x0D
    .byte 0x0D,0x0D,0x0D,0x0C,0x0C,0x0C,0x0B,0x0B
    .byte 0x0B,0x0A,0x0A,0x0A,0x09,0x09,0x09,0x08
    .byte 0x08,0x07,0x07,0x06,0x06,0x06,0x05,0x05
    .byte 0x04,0x04,0x03,0x03,0x02,0x02,0x01,0x01
    .byte 0x00,0x00,0xFF,0xFF,0xFE,0xFE,0xFD,0xFD
    .byte 0xFC,0xFC,0xFB,0xFB,0xFA,0xFA,0xFA,0xF9
    .byte 0xF9,0xF8,0xF8,0xF7,0xF7,0xF7,0xF6,0xF6
    .byte 0xF6,0xF5,0xF5,0xF5,0xF4,0xF4,0xF4,0xF3
    .byte 0xF3,0xF3,0xF3,0xF2,0xF2,0xF2,0xF2,0xF1
    .byte 0xF1,0xF1,0xF1,0xF1,0xF0,0xF0,0xF0,0xF0
    .byte 0xF0,0xEF,0xEF,0xEF,0xEF,0xEF,0xEF,0xEF
    .byte 0xEF,0xEE,0xEE,0xEE,0xEE,0xEE,0xEE,0xEE
    .byte 0xEE,0xEE,0xEE,0xEE,0xEE,0xEE,0xEE,0xEE
    .byte 0xEE,0xEF,0xEF,0xEF,0xEF,0xEF,0xEF,0xEF
    .byte 0xEF,0xF0,0xF0,0xF0,0xF0,0xF0,0xF1,0xF1
    .byte 0xF1,0xF1,0xF1,0xF2,0xF2,0xF2,0xF2,0xF3
    .byte 0xF3,0xF3,0xF3,0xF4,0xF4,0xF4,0xF5,0xF5
    .byte 0xF5,0xF6,0xF6,0xF6,0xF7,0xF7,0xF7,0xF8
    .byte 0xF8,0xF9,0xF9,0xFA,0xFA,0xFA,0xFB,0xFB
