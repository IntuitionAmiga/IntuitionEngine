...
; Video Chip:    TED (Commodore Plus/4 - 121 colors)
...
; Run:           ./bin/IntuitionEngine -68k ted_121_colors_68k.ie68
; Porting:       TED/PSG MMIO is CPU-agnostic. Port effort: rewrite sine tables
;                and loop structures for target CPU. 8-bit CPUs will need
;                optimized inner loops to maintain 60fps plasma update.
;
