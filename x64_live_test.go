...
func TestX64LiveStagesDemoPayloadOnIESHARE(t *testing.T) {
	...
	for _, want := range []string{
		...
		`payload_require_file "${SCRIPT_DIR}/sdk/examples/assets/music/Yummy_Pizza.sid" "make sdk-build"`,
		`payload_require_file "${SCRIPT_DIR}/sdk/examples/assets/rotozoomtexture_ehbasic.raw" "make rotozoom-textures"`,
		`payload_require_file "${SCRIPT_DIR}/sdk/examples/assets/music/enjoythesilence.mid" "make sdk-build"`,
		`payload_require_file "${SCRIPT_DIR}/sdk/examples/assets/splash_640x92.rgba" "make sdk-build"`,
		`payload_require_file "${SCRIPT_DIR}/sdk/examples/assets/music/adagioforstrings.mid" "make sdk-build"`,
		`payload_require_file "${SCRIPT_DIR}/sdk/examples/assets/resonance_scroll.rgba" "make sdk-build"`,
		...
		`payload_require_file "${payload_root}/SDK/Examples/assets/music/Yummy_Pizza.sid" "make sdk-build"`,
		`payload_require_file "${payload_root}/SDK/Examples/assets/rotozoomtexture_ehbasic.raw" "make rotozoom-textures"`,
		`payload_require_file "${payload_root}/SDK/Examples/assets/music/enjoythesilence.mid" "make sdk-build"`,
		`payload_require_file "${payload_root}/SDK/Examples/assets/splash_640x92.rgba" "make sdk-build"`,
		`payload_require_file "${payload_root}/SDK/Examples/assets/music/adagioforstrings.mid" "make sdk-build"`,
		`payload_require_file "${payload_root}/SDK/Examples/assets/resonance_scroll.rgba" "make sdk-build"`,
