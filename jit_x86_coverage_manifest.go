...
var x86JITCoverageManifest = []x86JITCoverageRow{
	...
	{"Grp2 word shift,CL", []byte{0x66, 0xD3, 0xE0}, x86JITCoverageDirect, x86JITCoverageDirect, x86JITCoverageUnavailable, "TestX86ARM64_DirectGroup2WordShiftCLParity"},
	...
	{"Grp2 carry rotate,CL", []byte{0xD3, 0xD0}, x86JITCoverageDirect, x86JITCoverageDirect, x86JITCoverageUnavailable, "TestX86ARM64_DirectGroup2CarryRotateCLParity"},
