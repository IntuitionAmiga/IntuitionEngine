...
var x86JITCoverageManifest = []x86JITCoverageRow{
	...
	{"x87 FLD ST(i)", []byte{0xD9, 0xC1}, x86JITCoverageDirect, x86JITCoverageFPUHelper, x86JITCoverageDirect, "TestX86WasmCompileBlockModule_DirectSimpleX87Forms"},
	...
	{"x87 FDECSTP/FINCSTP", []byte{0xD9, 0xF6}, x86JITCoverageDirect, x86JITCoverageFPUHelper, x86JITCoverageDirect, "TestX86WasmCompileBlockModule_DirectSimpleX87Forms"},
	{"x87 constant load", []byte{0xD9, 0xE8}, x86JITCoverageDirect, x86JITCoverageFPUHelper, x86JITCoverageDirect, "TestX86WasmCompileBlockModule_DirectSimpleX87Forms"},
	{"x87 register compare", []byte{0xD8, 0xD1}, x86JITCoverageDirect, x86JITCoverageFPUHelper, x86JITCoverageDirect, "TestX86WasmCompileBlockModule_DirectX87CompareForms"},
	{"x87 FTST", []byte{0xD9, 0xE4}, x86JITCoverageDirect, x86JITCoverageFPUHelper, x86JITCoverageDirect, "TestX86WasmCompileBlockModule_DirectX87CompareForms"},
	{"x87 FUCOM/FUCOMP", []byte{0xDD, 0xE1}, x86JITCoverageDirect, x86JITCoverageFPUHelper, x86JITCoverageDirect, "TestX86WasmCompileBlockModule_DirectX87CompareForms"},
	{"x87 pop arithmetic", []byte{0xDE, 0xC1}, x86JITCoverageDirect, x86JITCoverageFPUHelper, x86JITCoverageDirect, "TestX86WasmCompileBlockModule_DirectX87DERegisterPopArithmetic"},
