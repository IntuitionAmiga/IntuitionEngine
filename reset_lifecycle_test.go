...
func TestComponentReset_VideoChip(t *testing.T) {
	...
	if vc.directVRAM != nil {
		t.Error("VideoChip directVRAM should be nil after reset")
	}
	if vc.copperManagedByCompositor {
		t.Error("VideoChip copperManagedByCompositor should be false after reset")
	}
}
