...
var ioDevices = map[string]*IODeviceDesc{
	...
	"coproc": {
		...
		Registers: []IORegisterDesc{
			...
			{"COPROC_STATS_OPS", 0xF2378, 4, "RO"},
			{"COPROC_STATS_BYT", 0xF237C, 4, "RO"},
	...
	"voodoo": {
		...
		Registers: []IORegisterDesc{
			{"STATUS", 0xF8000, 4, "RO"},
			{"ENABLE", 0xF8004, 4, "WO"},
			{"VERTEX_AX", 0xF8008, 4, "RW"},
			{"VERTEX_AY", 0xF800C, 4, "RW"},
			{"VERTEX_BX", 0xF8010, 4, "RW"},
			{"VERTEX_BY", 0xF8014, 4, "RW"},
			{"VERTEX_CX", 0xF8018, 4, "RW"},
			{"VERTEX_CY", 0xF801C, 4, "RW"},
			{"START_R", 0xF8020, 4, "RW"},
			{"START_G", 0xF8024, 4, "RW"},
			{"START_B", 0xF8028, 4, "RW"},
			{"START_Z", 0xF802C, 4, "RW"},
			{"START_A", 0xF8030, 4, "RW"},
			{"START_S", 0xF8034, 4, "RW"},
			{"START_T", 0xF8038, 4, "RW"},
			{"START_W", 0xF803C, 4, "RW"},
			...
			{"DWDY", 0xF807C, 4, "RW"},
			// Commands
			{"TRIANGLE_CMD", 0xF8080, 4, "WO"},
			{"FTRIANGLE_CMD", 0xF8084, 4, "WO"},
			{"COLOR_SELECT", 0xF8088, 4, "RW"},
			// Configuration
			{"FBZCOLOR_PATH", 0xF8104, 4, "RW"},
			{"FOG_MODE", 0xF8108, 4, "RW"},
			{"ALPHA_MODE", 0xF810C, 4, "RW"},
			{"FBZ_MODE", 0xF8110, 4, "RW"},
			{"LFB_MODE", 0xF8114, 4, "RW"},
			{"CLIP_LEFT_RIGHT", 0xF8118, 4, "RW"},
			{"CLIP_LOW_Y_HIGH", 0xF811C, 4, "RW"},
			{"NOP_CMD", 0xF8120, 4, "WO"},
			{"FAST_FILL_CMD", 0xF8124, 4, "WO"},
			{"SWAP_BUFFER", 0xF8128, 4, "WO"},
			// Fog table (64 entries, showing base only)
			{"FOG_TABLE_BASE", 0xF8140, 4, "RW"},
			// Colors
			{"FOG_COLOR", 0xF81C4, 4, "RW"},
			{"ZA_COLOR", 0xF81C8, 4, "RW"},
			{"CHROMA_KEY", 0xF81CC, 4, "RW"},
			{"CHROMA_RANGE", 0xF81D0, 4, "RW"},
			{"STIPPLE", 0xF81D4, 4, "RW"},
			{"COLOR0", 0xF81D8, 4, "RW"},
			{"COLOR1", 0xF81DC, 4, "RW"},
			// FBI init
			{"FBI_INIT0", 0xF8200, 4, "RW"},
			{"FBI_INIT1", 0xF8204, 4, "RW"},
			{"FBI_INIT2", 0xF8208, 4, "RW"},
			{"FBI_INIT3", 0xF820C, 4, "RW"},
			{"FBI_INIT4", 0xF8210, 4, "RW"},
			// Video timing
			{"VIDEO_DIM", 0xF8214, 4, "RW"},
			{"BACK_PORCH", 0xF8218, 4, "RW"},
			{"VIDEO_DIM_V", 0xF821C, 4, "RW"},
			{"H_SYNC", 0xF8220, 4, "RW"},
			{"V_SYNC", 0xF8224, 4, "RW"},
			{"DAC_DATA", 0xF822C, 4, "RW"},
			// Texture
			{"TEX_MODE", 0xF8300, 4, "RW"},
			{"TLOD", 0xF8304, 4, "RW"},
			{"TDETAIL", 0xF8308, 4, "RW"},
			{"TEX_BASE0", 0xF830C, 4, "RW"},
			{"TEX_BASE1", 0xF8310, 4, "RW"},
			{"TEX_BASE2", 0xF8314, 4, "RW"},
			{"TEX_BASE3", 0xF8318, 4, "RW"},
			{"TEX_BASE4", 0xF831C, 4, "RW"},
			{"TEX_BASE5", 0xF8320, 4, "RW"},
			{"TEX_BASE6", 0xF8324, 4, "RW"},
			{"TEX_BASE7", 0xF8328, 4, "RW"},
			{"TEX_BASE8", 0xF832C, 4, "RW"},
